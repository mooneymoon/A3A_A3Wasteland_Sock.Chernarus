...
[] spawn {
	...
	while {true} do
	{
		...
		((uiNamespace getVariable "osefStatusBar")displayCtrl 1000)ctrlSetText format["TS.A3ARMORY.COM| PLAYERS ALIVE: %2 | AVERAGE FPS: %1", round diag_fps, count playableUnits];
	}; 
};