...
storePurchaseHandle = _this spawn
{
	...
	_showInsufficientDonatorError =
	{
		...
		hint parseText format ["<t color='#ffff00'>The purchase of custom vehicle paint available for community supporters. Use without vehicle paint.</t><br/>The purchase of ""%1"" has been cancelled.", _itemText];
		playSound "FD_CP_Not_Clear_F";
		_price = -1;
	};
